...
namespace DIPLOM_RAYKHERT.MyForm.Teacher
{
    public partial class TeacherEditForm : Form
    {
        ...
        string old_phone;
        string old_email;
        public TeacherEditForm(string idx, string surname, string name, string lastName,
            string phone, string email)
        {
            InitializeComponent();
            this.KeyPreview = true;
            this.KeyDown += TeacherEditForm_KeyDown;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                (phone == "") || (email == ""))
            {
                System.Windows.Forms.MessageBox.Show(
                    "Ошибка при редактировании преподавателя. Заполните все поля!",
                    "Ошибка",
            ...
            {
                System.Windows.Forms.MessageBox.Show(
                    "Ошибка при редактировании преподавателя. Введите номер телефона полностью!",
                    "Ошибка",
                    MessageBoxButtons.OK,
                    MessageBoxIcon.Error);
                return;
            ...
            if (TeacherClass.EditTeacher(id, name, surname, lastName, phone, email,
        ...
        private void TeacherEditForm_KeyDown(object sender, KeyEventArgs e)
        {
            HelpForm.hint = $@"
            Для редактирования преподавателя, необходимо:
