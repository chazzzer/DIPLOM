...
namespace DIPLOM_RAYKHERT.MyForm.Teacher
{
    public partial class TeacherAddForm : Form
    {
        public TeacherAddForm()
        {
            ...
            this.KeyDown += TeacherAddForm_KeyDown;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                (phone == "") || (email == ""))
            {
                System.Windows.Forms.MessageBox.Show(
                    "Ошибка при добавлении преподавателя. Заполните все поля!",
                    "Ошибка",
            ...
            {
                System.Windows.Forms.MessageBox.Show(
                    "Ошибка при добавлении преподавателя. Введите номер телефона полностью!",
                    "Ошибка",
                    MessageBoxButtons.OK,
                    MessageBoxIcon.Error);
                return;
            ...
            if (TeacherClass.AddTeacher(name, surname, lastName, phone, email) == false)
            {
                return;
            }
        ...
        private void TeacherAddForm_KeyDown(object sender, KeyEventArgs e)
        {
            HelpForm.hint = $@"
            Для добавления преподавателя, необходимо:
